...
public record CreateRequestDto(
        ...
        @NotNull(message = "Required specialization must not be null") Specialization specialization,
        @NotNull(message = "Scheduled date must not be null")
        @Future(message = "Scheduled date must be in the future") LocalDateTime scheduledAt
) {}