...
public record UserInfoDto(
        @Schema(description = "Unique identifier of the user.") String id,
        @Schema(description = "Full name of the user.") String name,
        @Schema(description = "Email address of the user.") String email,
        @Schema(description = "Role of the user (e.g., RESIDENT, ADMIN, TECHNICIAN).") Role role,
