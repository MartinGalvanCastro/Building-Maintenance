...
public record MaintenanceRequestSummaryDto(
        @Schema(description = "Unique identifier of the maintenance request.") UUID id,
        @Schema(description = "Status of the maintenance request.") String status,
        @Schema(description = "Date and time when the request was created.")
                LocalDateTime createdAt,
        @Schema(description = "Description of the maintenance request.") String description,
        @Schema(description = "Specialization required for the request.") String specialization,
        @Schema(description = "Scheduled date and time for the request.") LocalDateTime scheduledAt,
