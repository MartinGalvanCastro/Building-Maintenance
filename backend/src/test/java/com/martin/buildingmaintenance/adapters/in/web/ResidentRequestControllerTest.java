...
class ResidentRequestControllerTest {
    ...
    @MockitoBean private ResidentRequestService svc;
    ...
    private static final Arguments[] ROLES =
            new Arguments[] {arguments("ADMIN", ADMIN_ID), arguments("RESIDENT", RESIDENT_ID)};
    ...
    class GetResidentRequests {
        ...
        void list_requests_invalid_token_returns_403() throws Exception {
            ...
            mockMvc.perform(
                            get("/residents/" + RESIDENT_ID + "/requests")
    ...
    class CreateResidentRequest {
        ...
        void create_request_missing_fields_returns_400() throws Exception {
            ...
            String payload = "{" + "\"scheduledAt\": \"" + FUTURE_DATE + "\"}";
            mockMvc.perform(
    ...
    class CancelResidentRequest {
        ...
        void cancel_request_not_found_returns_404() throws Exception {
            ...
            mockMvc.perform(
                            delete("/residents/" + RESIDENT_ID + "/requests/" + REQUEST_ID)
                                    .header("Authorization", "Bearer " + VALID_TOKEN))
                    .andExpect(status().isNotFound());
        }
